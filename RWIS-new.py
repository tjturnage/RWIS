...
for line in fdat:
    ...
    #hoverText = f'  Text:  {latitude}, {longitude}, 1, " ", "{dat[0]}"\n'
    #print(hoverText)
    #tempPlace = objTemp + hoverText + tempPlace + ' End:\n\n'
    objTemp = f'Object: {latitude},{longitude}\n'
    hoverText = f'  Text:  {latitude}, {longitude}, 1, " ", "{dat[0]}"\n'
    tempPlace = f'{objTemp}{hoverText}{tempPlace} End:\n\n'
